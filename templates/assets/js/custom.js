...
document.addEventListener("DOMContentLoaded", () => {
	...
	// 			this.innerHTML = `
	// 			<div class="joe_pdf">
	//         <iframe src="${ThemeConfig_BASE_RES_URL}/source/lib/pdfjs/web/viewer.html?file=${this.options.src}" style="width:${this.options.width};height:${this.options.height}"></iframe>
	//       </div>`;
	// 		}
	// 	}
	// );
